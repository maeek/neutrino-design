...
export const EmojiQuickSelector = (props: EmojiQuickSelectorProps) => {
  const { quickAccessEmojis, onSelect, onClose, onOpen, renderMoreSelector } = props;
  ...
  const thumbClasses = classNames('ne-emoji-selector-thumb', isInit && 'ne-emoji-selector-thumb--visible');
  ...
  return (
    <div className='ne-emoji-selector'>
      ...
      {renderMoreSelector && (
        <div
          className='ne-emoji-selector-more-btn'
