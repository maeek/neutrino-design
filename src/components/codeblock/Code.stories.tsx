...
const Template: Story<CodeProps> = args => <CodeComponent {...args}>{text}</CodeComponent>;

export const Code = Template.bind({});
Code.args = {};

const TemplateBlock: Story<CodeProps> = args => <CodeBlockComponent {...args}>{text}</CodeBlockComponent>;
